...
const CustomBreadcrumbSidebar = () => {
    ...
    return (
        <>
            <PluginSidebar name="breadcrumb-sidebar" title="breadcrumb">
                <PanelBody title='Custom Breadcrumbs'>
                    <ToggleControl
                        label="Use Custom Breadcrumbs"
                        checked={meta.use_custom_breadcrumbs}
                        onChange={(value) => setMeta({ ...meta, use_custom_breadcrumbs: value })}
                    />
                    {
                        meta.use_custom_breadcrumbs && (
                            <AsyncSelect
                                cacheOptions
                                defaultOptions
                                isClearable
                                ...
                                value={meta.custom_breadcrumbs}
                                onChange={(value) => setMeta({ ...meta, custom_breadcrumbs: value })}
                            />
                        )
                    }
                </PanelBody>
...
registerPlugin('breadcrumb-sidebar', {
    ...
    render: CustomBreadcrumbSidebar,
});
